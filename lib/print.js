...
console.log(`
𝄢 · • —– ٠ ✤ ٠ —– • · · • —– ٠ ✤ ٠ —– • ·✧༄
❚ ▸ ${chalk.cyan('𝐁𝐎𝐓 ❱❱')} ${chalk.bgMagenta(chalk.white.italic('%s'))}
❚ ▸ ${chalk.cyan('𝐇𝐎𝐑𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.black.bgWhite('%s')}
❚ ${chalk.magentaBright('°o.OO.o°°o.OO.o°°o.OO.o°')}
❚ ▸ ${chalk.green('𝐀𝐂𝐂𝐈𝐎𝐍 ❱❱')} ${await formatMessageStubType(m.messageStubType, name_user)}
❚ ▸ ${chalk.green('𝐔𝐒𝐔𝐀𝐑𝐈𝐎 ❱❱')} ${chalk.white('%s')} / ${chalk.bgMagentaBright.bold(user.role.replace(/\*/g, ''))} / Premium » ${user?.premiumTime > 0 ? '✅' : '❌'}
❚ ▸ ${chalk.green('𝐑𝐄𝐂𝐔𝐑𝐒𝐎𝐒 ❱❱')} ${chalk.cyan('%s%s')}
❚ ▸ %s
❚ ${chalk.magentaBright('°o.OO.o°°o.OO.o°°o.OO.o°')}
❚ ▸ ${chalk.redBright('𝐏𝐄𝐒𝐎 ❱❱')} ${chalk.blueBright('%s (%s %sB)')}
❚ ▸ ${chalk.redBright('𝐓𝐈𝐏𝐎 ❱❱')} ${chalk.greenBright.bold('[%s]')}
𝄢 · • —– ٠ ✤ ٠ —– • · · • —– ٠ ✤ ٠ —– • ·✧༄`.trim(),          
...
(m.chat.includes("@g.us") ? `${chalk.green('𝐆𝐑𝐔𝐏𝐎 ❱❱')} ${chalk.yellowBright.italic(`${m.chat} ~${chat}`)}` : `${chalk.green('𝐏𝐑𝐈𝐕𝐀𝐃𝐎 ❱❱')} ${chalk.yellowBright.italic(`${m.sender} ~${user.name ? user.name : conn.getName(m.sender)}`)} `),
filesize,
