...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} مــبــارك لــقــد ربـحـت 4999 خــبــره` : isTie ? '⌯ انــتــهــت الــمــبــاراه بالــتــعــادل 😐' : `⌯ دور @${room.game.currentTurn.split('@')[0]}`}
`.trim()
